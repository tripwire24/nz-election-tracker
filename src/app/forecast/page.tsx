...
export default async function ForecastPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-stone-900 dark:text-stone-100">Forecast</h1>
        ...
        {hasPollData ? (
          <>
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/40 p-4 text-center">
                {hasMC ? (
                  <>
              ...
              <div className="rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/40 p-4 text-center">
                {hasMC ? (
                  <>
              ...
              <div key={p.short} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-sm text-stone-600 dark:text-stone-300">{p.name}</span>
                    <span className="text-sm font-semibold text-stone-700 dark:text-stone-200">{p.seats} seats</span>
                  </div>
                ...
                return (
                  <div key={party} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="relative h-3 w-full rounded bg-stone-100 dark:bg-stone-700">
                        {/* p5–p95 range bar */}
                        <div
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-lg border border-stone-200 dark:border-stone-700 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-sm font-medium text-stone-700 dark:text-stone-200">Polling average</h3>
            </div>
          ...
          <div className="rounded-lg border border-stone-200 dark:border-stone-700 p-4">
            <div className="flex items-center gap-2 mb-2">
              <div className="h-8 w-8 rounded-lg bg-stone-100 dark:bg-stone-700 flex items-center justify-center text-stone-400 text-sm font-bold">2</div>
              <h3 className="text-sm font-medium text-stone-700 dark:text-stone-200">Sentiment index</h3>
            </div>
            <p className="text-xs text-stone-500 dark:text-stone-400">
          ...
          <div className="rounded-lg border border-stone-200 dark:border-stone-700 p-4">
            <div className="flex items-center gap-2 mb-2">
              <div className={`h-8 w-8 rounded-lg flex items-center justify-center text-sm font-bold ${hasMC ? "bg-emerald-50 text-emerald-600" : "bg-stone-100 dark:bg-stone-700 text-stone-400"}`}>{hasMC ? "✓" : "3"}</div>
              <h3 className="text-sm font-medium text-stone-700 dark:text-stone-200">Monte Carlo</h3>
            </div>
            <p className="text-xs text-stone-500 dark:text-stone-400">
              {hasMC
      ...
      {/* Roadmap */}
      <div className="rounded-xl border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-800 p-6">
        <h2 className="text-sm font-semibold text-stone-700 dark:text-stone-200 mb-3">Model roadmap</h2>
        <div className="grid gap-3 md:grid-cols-4">
          <div className="flex items-center gap-3 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 px-3 py-2.5 ring-1 ring-emerald-200 dark:ring-emerald-800">
            <span className="text-emerald-600 font-bold">✓</span>
            <div>
              <div className="text-xs font-semibold text-stone-700 dark:text-stone-200">Polling data</div>
          ...
          <div className="flex items-center gap-3 rounded-lg bg-emerald-50 px-3 py-2.5 ring-1 ring-emerald-200">
            <span className="text-emerald-600 font-bold">✓</span>
            <div>
              <div className="text-xs font-semibold text-stone-700 dark:text-stone-200">Historical results</div>
          ...
          <div className="flex items-center gap-3 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 px-3 py-2.5 ring-1 ring-emerald-200 dark:ring-emerald-800">
            <span className="text-emerald-600 font-bold">✓</span>
            <div>
              <div className="text-xs font-semibold text-stone-700 dark:text-stone-200">Weighted average</div>
              <div className="text-[10px] text-stone-400">14-day half-life decay</div>
            </div>
          </div>
          <div className={`flex items-center gap-3 rounded-lg px-3 py-2.5 ring-1 ${hasMC ? "bg-emerald-50 dark:bg-emerald-950/40 ring-emerald-200 dark:ring-emerald-800" : "bg-stone-50 dark:bg-stone-800 ring-stone-200 dark:ring-stone-700"}`}>
            <span className={`font-bold ${hasMC ? "text-emerald-600" : "text-stone-400"}`}>{hasMC ? "✓" : "○"}</span>
            <div>
              <div className="text-xs font-semibold text-stone-700 dark:text-stone-200">Monte Carlo</div>
