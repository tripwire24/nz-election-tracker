    ...
    >
      ...
      >
        ...
        <div className="mt-4 rounded-xl border border-white/10 bg-[#1a1a1a] p-4">
          <div className="mb-2 flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wider text-neutral-400">
        ...
        <a
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-neutral-600 to-neutral-700 px-4 py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90"
        >
          Read full article
